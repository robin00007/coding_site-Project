...
import loginImage from "../public/banners/login_svg.svg";
import style from "../styles/pageas/login.module.css";
import Link from "next/link";
import signInWithGoogle from "../components/authFeature/googleAuth";
import signoutFromGoogle from "../components/authFeature/signoutFromGoogle";
...
function MyApp({ Component, pageProps }) {
  return (
    <div className={style.loginContainer}>
      ...
      <div className={style.loginContainer}>
        <div className={style.loginImageContaner}>
          <Image src={loginImage}></Image>
        </div>
        <div className={style.loginformContaner}>
          <br></br>
          <h1>
            Hii ! <br></br>Welcome back{" "}
          </h1>
          ...
          <button
            className={style.LoginWithGoogleButton}
          ...
          <h3>
            ...
            <Link className={style.signInButton} href="/signIn">
              Sign In
            </Link>{" "}
          </h3>
        </div>
