    ...
    <div className={style.loginContainer}>
      ...
      <div className={style.loginContainer}>
        ...
        <div className={style.loginformContaner}>
          ...
          <h3>Please register with your email</h3>
          <form action="/send-data-here" method="post">
            ...
            <button type="submit" className={style.LoginWithGoogleButton}>
            ...
            <h3>
              Already have a accounta ?
              <Link className={style.signInButton} href="/login">
                logIn
              </Link>{" "}
            </h3>
          </form>
